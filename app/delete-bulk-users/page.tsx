...
const handleDelete = (e: any) => {
  ...
  const handleSubmit = (e: any) => {
    ...
    axios
      .post(
        `${SERVER_URL}/admin/delete-bulk-users`,
        {
          district: district,
  ...
  return (
    <Sidebar>
      <div>
        <h1 className="text-3xl font-bold mx-auto">Delete Users</h1>
            <p>
                Be Careful when deleting users. It will delete all the data related to the user.
            </p>
        ...
        <div className="max-w-sm mx-auto my-5">
          <button
            className="bg-primary text-white w-full py-3 rounded-lg bg-red-500"
